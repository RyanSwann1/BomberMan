...
BombHighPower::BombHighPower(const std::string & name, EntityTag tag, const sf::Vector2f & position, EntityManager & entityManager, int entityID, bool collidable)
	: Bomb(name, tag, position, entityManager, entityID, collidable, BombPower::High, 3)
{
}

std::vector<sf::Vector2f> BombHighPower::getExplosionSpawnPositions() const
{
