...
BombLowPower::BombLowPower(const std::string & name, EntityTag tag, const sf::Vector2f & position, EntityManager & entityManager, int entityID, bool collidable)
	: Bomb(name, tag, position, entityManager, entityID, collidable, BombPower::Low, 1)
{
}

std::vector<sf::Vector2f> BombLowPower::getExplosionSpawnPositions() const
{
